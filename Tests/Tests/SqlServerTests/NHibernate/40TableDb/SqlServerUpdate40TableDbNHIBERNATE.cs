...
{
    public class SqlServerUpdate40TableDbNHIBERNATE
    {
        public UpdateTestHelperNHIBERNATE TestHelperNHIBERNATE;
        public string ConnectionString;
        public SqlServerUpdate40TableDbNHIBERNATE()
        {
            TestHelperNHIBERNATE = new UpdateTestHelperNHIBERNATE();
            ConnectionString = "SqlServer40Table";
        }
