...
using Tests.Tests.SqlServerTests.NHibernate.HelperForTests;

namespace Tests.Tests.SqlServerTests.NHibernate._80TableDb
{
    public class SqlServerDelete80TableDbNHIBERNATE
    {
        public DeleteTestHelperNHIBERNATE TestHelper;

        public SqlServerDelete80TableDbNHIBERNATE()
        {
            TestHelper = new DeleteTestHelperNHIBERNATE("SqlServer80Table");
        }
        ...
        public void DeleteTableDb()
        {
            ...
            var Task41 = new Task(() => TestHelper.DeleteFromTableByRecord1<Table_41>("Table_41"));
            var Task42 = new Task(() => TestHelper.DeleteFromTableByRecord2<Table_42>("Table_42"));
            var Task43 = new Task(() => TestHelper.DeleteFromTableByRecord3<Table_43>("Table_43"));
            var Task44 = new Task(() => TestHelper.DeleteFromTableByRecord4<Table_44>("Table_44"));
            var Task45 = new Task(() => TestHelper.DeleteFromTableByRecord5<Table_45>("Table_45"));
            var Task46 = new Task(() => TestHelper.DeleteFromTableByRecord6<Table_46>("Table_46"));
            var Task47 = new Task(() => TestHelper.DeleteFromTableByRecord7<Table_47>("Table_47"));
            var Task48 = new Task(() => TestHelper.DeleteFromTableByRecord8<Table_48>("Table_48"));
            var Task49 = new Task(() => TestHelper.DeleteFromTableByRecord9<Table_49>("Table_49"));
            var Task50 = new Task(() => TestHelper.DeleteFromTableByRecord10<Table_50>("Table_50"));
            var Task51 = new Task(() => TestHelper.DeleteFromTableByRecord1<Table_51>("Table_51"));
            var Task52 = new Task(() => TestHelper.DeleteFromTableByRecord2<Table_52>("Table_52"));
            var Task53 = new Task(() => TestHelper.DeleteFromTableByRecord3<Table_53>("Table_53"));
            var Task54 = new Task(() => TestHelper.DeleteFromTableByRecord4<Table_54>("Table_54"));
            var Task55 = new Task(() => TestHelper.DeleteFromTableByRecord5<Table_55>("Table_55"));
            var Task56 = new Task(() => TestHelper.DeleteFromTableByRecord6<Table_56>("Table_56"));
            var Task57 = new Task(() => TestHelper.DeleteFromTableByRecord7<Table_57>("Table_57"));
            var Task58 = new Task(() => TestHelper.DeleteFromTableByRecord8<Table_58>("Table_58"));
            var Task59 = new Task(() => TestHelper.DeleteFromTableByRecord9<Table_59>("Table_59"));
            var Task60 = new Task(() => TestHelper.DeleteFromTableByRecord10<Table_60>("Table_60"));
