...
{
    public class SqlServerOuterJoin80TableDbNHIBERNATE
    {
        ...
        public SqlServerOuterJoin80TableDbNHIBERNATE()
        {
        ...
        public List<ModelFor80TableOuterJoin> GetOuterJoinResults()
        {
            ...
            var result = SqlServerRepository.GeJoinFromTableDB<ModelFor80TableOuterJoin>(SqQueries.OuterJoin80Table);
        ...
        public void GetOuterJoinResultsMultiUser()
        {
            ...
            var outerJoinsTask1 = new Task<IList<ModelFor80TableOuterJoin>>(() => RpositoryArray[0].GeJoinFromTableDB<ModelFor80TableOuterJoin>(SqQueries.OuterJoin80Table));
            var outerJoinsTask2 = new Task<IList<ModelFor80TableOuterJoin>>(() => RpositoryArray[1].GeJoinFromTableDB<ModelFor80TableOuterJoin>(SqQueries.OuterJoin80Table));
            var outerJoinsTask3 = new Task<IList<ModelFor80TableOuterJoin>>(() => RpositoryArray[2].GeJoinFromTableDB<ModelFor80TableOuterJoin>(SqQueries.OuterJoin80Table));
            var outerJoinsTask4 = new Task<IList<ModelFor80TableOuterJoin>>(() => RpositoryArray[3].GeJoinFromTableDB<ModelFor80TableOuterJoin>(SqQueries.OuterJoin80Table));
            var outerJoinsTask5 = new Task<IList<ModelFor80TableOuterJoin>>(() => RpositoryArray[4].GeJoinFromTableDB<ModelFor80TableOuterJoin>(SqQueries.OuterJoin80Table));
            var outerJoinsTask6 = new Task<IList<ModelFor80TableOuterJoin>>(() => RpositoryArray[5].GeJoinFromTableDB<ModelFor80TableOuterJoin>(SqQueries.OuterJoin80Table));
            var outerJoinsTask7 = new Task<IList<ModelFor80TableOuterJoin>>(() => RpositoryArray[6].GeJoinFromTableDB<ModelFor80TableOuterJoin>(SqQueries.OuterJoin80Table));
            var outerJoinsTask8 = new Task<IList<ModelFor80TableOuterJoin>>(() => RpositoryArray[7].GeJoinFromTableDB<ModelFor80TableOuterJoin>(SqQueries.OuterJoin80Table));
            var outerJoinsTask9 = new Task<IList<ModelFor80TableOuterJoin>>(() => RpositoryArray[8].GeJoinFromTableDB<ModelFor80TableOuterJoin>(SqQueries.OuterJoin80Table));
            var outerJoinsTask10 = new Task<IList<ModelFor80TableOuterJoin>>(() => RpositoryArray[9].GeJoinFromTableDB<ModelFor80TableOuterJoin>(SqQueries.OuterJoin80Table));
