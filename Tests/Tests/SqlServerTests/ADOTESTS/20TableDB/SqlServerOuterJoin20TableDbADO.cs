...
{
    public class SqlServerOuterJoin20TableDbADO
    {
        ...
        public SqlServerOuterJoin20TableDbADO()
        {
        ...
        {
            var result = sqlServerRpositoryAdo.GetDataFromDb<ModelFor20TableOuterJoin>(SqQueries.OuterJoin20Table);
