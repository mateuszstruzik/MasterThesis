...
{
    public class PostgreSQLServerDelete80TableDbNHIBERNATE
    {
        public PostgreSQLDeleteTestHelperNHIBERNATE TestHelper;

        public PostgreSQLServerDelete80TableDbNHIBERNATE()
        {
            TestHelper = new PostgreSQLDeleteTestHelperNHIBERNATE("PostgreSQLServer80Table");
        }
