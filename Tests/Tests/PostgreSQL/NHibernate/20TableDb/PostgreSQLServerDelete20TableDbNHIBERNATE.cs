...
{
    public class PostgreSQLServerDelete20TableDbNHIBERNATE
    {
        public PostgreSQLDeleteTestHelperNHIBERNATE TestHelper;

        public PostgreSQLServerDelete20TableDbNHIBERNATE()
        {
            TestHelper = new PostgreSQLDeleteTestHelperNHIBERNATE("PostgreSQLServer20Table");
        }
