...
{
    public class PostgreSQLServerDelete80TableDbADO
    {
        public PostgreSQLDeleteTestHelper TestHelper;

        public PostgreSQLServerDelete80TableDbADO()
        {
            TestHelper = new PostgreSQLDeleteTestHelper("PostgreSQLServer80Table");
        }
        ...
        public void DeleteTableDb()
        {
            ...
            var Task35 = new Task(() => TestHelper.DeleteFromTableByRecord5("Table_35"));
