...
{
    public class PostgreSQLServerUpdate80TableDbADO
    {
        public PostgreSQLUpdateTestHelper UpdateTestHelper;

        public PostgreSQLServerUpdate80TableDbADO()
        {
            UpdateTestHelper = new PostgreSQLUpdateTestHelper("PostgreSQLServer80Table");
        }
