...
{
    public class PostgreSQLServerUpdate40TableDbADO
    {
        public PostgreSQLUpdateTestHelper UpdateTestHelper;

        public PostgreSQLServerUpdate40TableDbADO()
        {
            UpdateTestHelper = new PostgreSQLUpdateTestHelper("PostgreSQLServer40Table");
        }
