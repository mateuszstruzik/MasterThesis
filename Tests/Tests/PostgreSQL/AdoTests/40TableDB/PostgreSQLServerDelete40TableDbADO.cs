...
{
    public class PostgreSQLServerDelete40TableDbADO
    {
        public PostgreSQLDeleteTestHelper TestHelper;

        public PostgreSQLServerDelete40TableDbADO()
        {
            TestHelper = new PostgreSQLDeleteTestHelper("PostgreSQLServer40Table");
        }
