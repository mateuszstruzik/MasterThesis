...
{
    public class PostgreSQLServerDelete20TableDbADO
    {
        public PostgreSQLDeleteTestHelper TestHelper;

        public PostgreSQLServerDelete20TableDbADO()
        {
            TestHelper = new PostgreSQLDeleteTestHelper("PostgreSQLServer20Table");
        }
