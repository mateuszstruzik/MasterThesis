...
{
    public class PostgreSQLServerOuterJoin20TableDbADO
    {
        ...
        public PostgreSQLServerOuterJoin20TableDbADO()
        {
            ServerRepository = new PostgreSqlServerRpositoryAdo(ConfigurationManager.ConnectionStrings["PostgreSQLServer20Table"].ConnectionString);
        ...
        {
            var result = ServerRepository.GetDataFromDb<ModelFor20TableOuterJoin>(SqQueries.OuterJoin20Table);
