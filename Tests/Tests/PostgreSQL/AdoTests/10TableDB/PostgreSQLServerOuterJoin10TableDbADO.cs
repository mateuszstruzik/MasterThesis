...
{
    public class PostgreSQLServerOuterJoin10TableDbADO
    {
        ...
        public PostgreSQLServerOuterJoin10TableDbADO()
        {
            ServerRepository = new PostgreSqlServerRpositoryAdo(ConfigurationManager.ConnectionStrings["PostgreSQLServer10Table"].ConnectionString);
        ...
        {
            var result = ServerRepository.GetDataFromDb<ModelFor10TableOuterJoin>(SqQueries.SqlSerwerOuterJoin10Table);
