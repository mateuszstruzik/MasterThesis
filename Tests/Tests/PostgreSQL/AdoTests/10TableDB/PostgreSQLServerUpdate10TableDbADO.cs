...
{
    public class PostgreSQLServerUpdate10TableDbADO
    {
        public PostgreSQLUpdateTestHelper UpdateTestHelper;

        public PostgreSQLServerUpdate10TableDbADO()
        {
            UpdateTestHelper = new PostgreSQLUpdateTestHelper("PostgreSQLServer10Table");
        }
