...
{
    public class PostgreSQLServerDelete10TableDbADO
    {
        public PostgreSQLDeleteTestHelper TestHelper;

        public PostgreSQLServerDelete10TableDbADO()
        {
            TestHelper = new PostgreSQLDeleteTestHelper("PostgreSQLServer10Table");
        }
