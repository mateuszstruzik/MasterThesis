...
{
    public class PostgreSQLServerInnerJoin10TableDbADO
    {
        ...
        public PostgreSQLServerInnerJoin10TableDbADO()
        {
            sqlServerRpositoryAdo = new PostgreSqlServerRpositoryAdo(ConfigurationManager.ConnectionStrings["PostgreSQLServer10Table"].ConnectionString);
