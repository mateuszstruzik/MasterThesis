...
{
    public class OracleServerOuterJoin40TableDbNHIBERNATE
    {
        ...
        public OracleServerOuterJoin40TableDbNHIBERNATE()
        {
            ServerRepository = new OracleDbServerRepositoryNHibernate(ConfigurationManager.ConnectionStrings["OracleDbServer40TableNHIBERNATE"].ConnectionString);

            for (int i = 0; i < objectNumber; i++)
            {
                RpositoryArray[i] = new OracleDbServerRepositoryNHibernate(ConfigurationManager.ConnectionStrings["OracleDbServer40TableNHIBERNATE"].ConnectionString);
            }
        }
        ...
        public List<ModelFor40TableOuterJoin> GetOuterJoinResults()
        {
            ...
            ServerRepository.InitSessionFactory<ModelFor40TableOuterJoin>();
            var result = ServerRepository.GetJoinFromTableDB<ModelFor40TableOuterJoin>(SqQueries.OuterJoin40Table);
