...
{
    public class OracleServerInnerJoin10TableDbNHIBERNATE
    {
        ...
        public OracleServerInnerJoin10TableDbNHIBERNATE()
        {
            SqlServerRepository = new OracleDbServerRepositoryNHibernate(ConfigurationManager.ConnectionStrings["OracleDbServer10TableNHIBERNATE"].ConnectionString);
