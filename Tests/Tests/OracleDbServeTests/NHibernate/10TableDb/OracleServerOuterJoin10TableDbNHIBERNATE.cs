...
{
    public class OracleServerOuterJoin10TableDbNHIBERNATE
    {
        ...
        public OracleServerOuterJoin10TableDbNHIBERNATE()
        {
            ServerRepository = new OracleDbServerRepositoryNHibernate(ConfigurationManager.ConnectionStrings["OracleDbServer10TableNHIBERNATE"].ConnectionString);
        ...
        public List<ModelFor10TableOuterJoin> GetOuterJoinResults()
        {
            ...
            ServerRepository.InitSessionFactory<ModelFor10TableOuterJoin>();
            var result = ServerRepository.GetJoinFromTableDB<ModelFor10TableOuterJoin>(SqQueries.SqlSerwerOuterJoin10TableNHIBERNATE);
