...
{
    public class OracleServerDelete10TableDbNHIBERNATE
    {
        public OracleDeleteTestHelperNHIBERNATE TestHelper;

        public OracleServerDelete10TableDbNHIBERNATE()
        {
            TestHelper = new OracleDeleteTestHelperNHIBERNATE("OracleDbServer10TableNHIBERNATE");
        }
