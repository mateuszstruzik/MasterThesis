...
{
    public class OracleServerDelete80TableDbNHIBERNATE
    {
        public OracleDeleteTestHelperNHIBERNATE TestHelper;

        public OracleServerDelete80TableDbNHIBERNATE()
        {
            TestHelper = new OracleDeleteTestHelperNHIBERNATE("OracleDbServer40TableNHIBERNATE");
        }
